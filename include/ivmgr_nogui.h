...
/*! \file 
  \brief Defines the IVmgrNoGui class which acts like the original IVmgrNoGui (handling 3D user interaction), but bypasses all GUI related actions.
 */
...
class IVmgrNoGui: public IVmgrAbstract {
